...
from .views import logout_view,wishlist_view,add_to_wishlist,remove_from_wishlist,loadReviews,contact_info_view,contact_us,success
from . import views
...
urlpatterns = [
    ...
    path('contact-info/', contact_info_view, name='contact_info'),
